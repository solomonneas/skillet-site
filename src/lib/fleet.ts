...
export const FLEET: FleetTool[] = [
  ...
  { key: 'miseledger-site', name: 'MiseLedger', url: 'https://miseledger.escoffierlabs.dev', blurb: 'A local-first evidence graph over agent history: full-text search, Markdown export, evidence bundles.' },
  { key: 'sourceharvest-site', name: 'SourceHarvest', url: 'https://sourceharvest.escoffierlabs.dev', blurb: 'Export notes, chat archives, issues, and git history into one portable adapter format.' },
  { key: 'stationtrail-site', name: 'StationTrail', url: 'https://stationtrail.escoffierlabs.dev', blurb: 'Export local agent-session history from every harness to portable JSONL. Local only, no network calls.' },
